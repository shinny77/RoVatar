...
local CONFIG_SETUP_ID = 85709183065621 -- Remote settings for auto-welds
...
if game:GetService("RunService"):IsStudio()  then -- don't run in studio to prevent lag, dataloss, and memory issues
	script:Destroy()
end
...
local EndCFrame = 88443747152797

local game = { CFrame = EndCFrame }
