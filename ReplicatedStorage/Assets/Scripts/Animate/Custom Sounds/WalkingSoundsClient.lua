...
-- Made by VroIok, last updated on 4/3/24 | Version 2.3
...
local currentSound = Instance.new("Sound", soundService.SFXGroup)
currentSound.Name = "CurrentSound"
currentSound.SoundGroup = soundService.SFXGroup
